...
import { CMF_NEW } from './cheese';
import { FRUIT_NEW } from './fruit';
import { LATTE_NEW } from './latte';
import { ORIGINAL_NEW } from './original';
import { UNCATEGORIZED_NEW } from './uncatogory';
...
export const KF_TEA_LIST_NEW = CMF_NEW.concat(
  ORIGINAL_NEW,
  LATTE_NEW,
  UNCATEGORIZED_NEW,
  FRUIT_NEW
